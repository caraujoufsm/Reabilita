...
<nav class="navbar navbar-expand-lg navbar-light" style="background: rgba(0,123,255,0.5);">
  ...
  <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
    <div class="navbar-nav">
      <a class="nav-item nav-link active" href="home"> <i class="fa fa-home fa-fw" aria-hidden="true"></i>&nbsp;Home <span class="sr-only">(current)</span></a>
      <a class="nav-item nav-link" href="servicos"> <i class="fa fa-ambulance fa-fw" aria-hidden="true"></i>&nbsp;Serviços</a>
...
<img src="img/logo.png" class="img-fluid" alt="Logo do Consultório">
</body>
</html>