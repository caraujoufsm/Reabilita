...
<html lang="en">
   ...
   <body>
      <nav class="navbar navbar-expand-lg navbar-light" style="background: rgba(0,123,255,0.5);">
         ...
         <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            <div class="navbar-nav">
               ...
               <a class="nav-item nav-link active" href="info"> <i class="fa fa-info-circle fa-fw" aria-hidden="true"></i>&nbsp;Informações Adicionais <span class="sr-only">(current)</span></a>
      ...
      <div class="row">
            ...
            <div class="col-md-4">   
               <aside class="navegacao-site mt-4">
